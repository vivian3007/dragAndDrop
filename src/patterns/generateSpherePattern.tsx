const generateSpherePattern = (singleShape: Shape, yarnWeight: string, PIXELS_PER_CM: number, rowHeights: Record<string, number>) => {
    ...
    for (let i = 0; i < decRows - 1; i++) {
        ...
        decArray.push(`Row ${rowArray[rowIndex]}: 1dec, ${decRows - i}sc (${currentStitches})`);
    }
